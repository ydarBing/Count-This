...
import com.gurpgork.countthis.core.datastore.preference.CountThisPreferences.Theme
...
class CountThisPreferencesImpl @Inject constructor(
    ...
    private val defaultThemeValue = "system"//context.getString(R.string.pref_theme_default_value)
...
//        sharedPreferences.registerOnSharedPreferenceChangeListener(listener)
    ...
    override fun observeTrackingLocation(): Flow<Int> = createPreferenceFlow(
        KEY_FOREGROUND_LOCATION_ENABLED
    ...
    private val Theme.storageKey: String
        get() = when (this) {
            Theme.LIGHT -> "light"//context.getString(R.string.pref_theme_light_value)
            Theme.DARK -> "dark"//context.getString(R.string.pref_theme_dark_value)
            Theme.SYSTEM -> "system"//context.getString(R.string.pref_theme_system_value)
        }

    private fun getThemeForStorageValue(value: String) = when (value) {
        /*context.getString(R.string.pref_theme_light_value)*/"light" -> Theme.LIGHT
        /*context.getString(R.string.pref_theme_dark_value)*/ "dark"-> Theme.DARK
        else -> Theme.SYSTEM
    }
