...
//import com.gurpgork.countthis.location.LocationEntity
...
//
//@Composable
//fun CountThisPreferences.shouldUseButtonIncrements(): Boolean {
...
// */
//fun LocationEntity?.toText(): String {
//    return if (this != null) {
...
// */
//fun android.location.Location?.toLocation(): LocationEntity? {
//    return if (this != null) {
//        LocationEntity(
//            time = time,
//            latitude = latitude,
